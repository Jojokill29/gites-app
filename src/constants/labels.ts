...
export const LABELS = {
  ...
  // Reservation form (new fields)
  adultCount: 'Nombre d\'adultes',
  taxAmount: 'Taxe de séjour (€)',
  giteCapacityHint: 'Capacité max :',
  errorGuestCountExceedsCapacity: 'Le nombre de personnes dépasse la capacité du gîte',
  errorAdultCountExceedsGuests: 'Le nombre d\'adultes ne peut pas dépasser le nombre de personnes.',
  ...
  notesHeader: 'Notes diverses',
  addNote: '+ Ajouter une note',
  amountField: 'Montant (€)',
  labelField: 'Description',
  staysSection: 'Séjours du trimestre',
  miscSection: 'Notes diverses',
  noStays: 'Aucune réservation pour ce trimestre.',
  noMiscEntries: 'Aucune note financière pour ce trimestre.',
  arrival: 'Arrivée',
  nights: 'Nuits',
  adults: 'Adultes',
  tax: 'Taxe',
  openReservation: 'Ouvrir la fiche',
