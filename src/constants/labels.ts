...
export const LABELS = {
  ...
  annualRevenue: 'Total CA',
  annualTaxes: 'Total Taxes',
  annualMisc: 'Total Notes diverses',
  ...
  taxSection: 'Taxes de séjour',
  miscSection: 'Notes diverses',
  addRevenue: '+ Ajouter une opération CA',
  addTax: '+ Ajouter une opération Taxe',
  ...
  nightsField: 'Nuits',
  adultsField: 'Adultes',
  noRevenueEntries: 'Aucune opération CA pour ce trimestre.',
  noTaxStays: 'Aucune opération taxe pour ce trimestre.',
  noMiscEntries: 'Aucune note financière pour ce trimestre.',
  newRevenueEntry: 'Nouvelle opération CA',
  editRevenueEntry: 'Modifier l\'opération CA',
  newTaxStay: 'Nouvelle opération Taxe',
  editTaxStay: 'Modifier l\'opération Taxe',
  newMiscEntry: 'Nouvelle note financière',
  editMiscEntry: 'Modifier la note financière',
  confirmDeleteEntry: 'Confirmer la suppression ?',
